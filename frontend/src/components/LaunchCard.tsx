            ...
            <div className="flex-1 flex gap-8 min-h-0">
                ...
                <div className="flex-1 flex flex-col gap-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2 bg-black/40 border border-cyan-900/50 p-4 rounded-lg hover:bg-cyan-950/20 hover:border-cyan-500/40 transition-all duration-300 cursor-default group relative overflow-hidden flex flex-col justify-center">
